...
![image-20250310112644517](images/2-Docker/image-20250310112644517.png)
...
![image-20250310113425445](images/2-Docker/image-20250310113425445.png)
...
![image-20250310121227399](images/2-Docker/image-20250310121227399.png)

以及对应的初始化SQL脚本和配置文件：

![image-20250310121234015](images/2-Docker/image-20250310121234015.png)

![image-20250310121238823](images/2-Docker/image-20250310121238823.png)

其中，hm.cnf主要是配置了MySQL的默认编码，改为utf8mb4；而hmall.sql则是后面我们要用到的黑马商城项目的初始化SQL脚本。

我们直接将整个mysql目录上传至虚拟机的`/root`目录下：

![image-20250310121245982](images/2-Docker/image-20250310121245982.png)
...
![image-20250310121431739](images/2-Docker/image-20250310121431739.png)
...
![image-20250310121645822](images/2-Docker/image-20250310121645822.png)

首先，我们将课前资料提供的`docker-demo.jar`包以及`Dockerfile`拷贝到虚拟机的`/root/demo`目录：

![image-20250310121655103](images/2-Docker/image-20250310121655103.png)
...
![image-20250310121728686](images/2-Docker/image-20250310121728686.png)
