...
![image-20250624141802153](images/3-MqAdvanced/image-20250624141802153.png)

放行以后，由于抛出的是**消息转换异常**，因此Spring会自动返回`reject`，所以消息依然会被删除：

![image-20250624141814821](images/3-MqAdvanced/image-20250624141814821.png)
...
![image-20250624141828190](images/3-MqAdvanced/image-20250624141828190.png)

放行以后，由于抛出的是业务异常，所以Spring返回`ack`，最终消息恢复至`Ready`状态，并且没有被RabbitMQ删除：

![image-20250624141841191](images/3-MqAdvanced/image-20250624141841191.png)
...
![image-20250624141916494](images/3-MqAdvanced/image-20250624141916494.png)
...
![image-20250624142042397](images/3-MqAdvanced/image-20250624142042397.png)
