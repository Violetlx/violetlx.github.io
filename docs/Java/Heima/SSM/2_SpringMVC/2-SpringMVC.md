---
title: 黑马SpringMVCDay02
date: 2025/06/20
---

![动漫女巫 发光蝴蝶](https://bizhi1.com/wp-content/uploads/2023/08/Anime-Witch-Glowing-Butterfly-4K-Wallpaper-small.jpg)
...
![1630561266760](images/2-SpringMVC/1630561266760.png)
...
![1630561591931](images/2-SpringMVC/1630561591931.png)
...
* 如何解决上述问题?
  ...
  * 设置错误提示级别
    ...
    ![](images/2-SpringMVC/1630600227357.png)
...
![1630600844191](images/2-SpringMVC/1630600844191.png)

查询所有，测试的结果为:

![1630600927486](images/2-SpringMVC/1630600927486.png)
...
![1630652582425](images/2-SpringMVC/1630652582425.png)
...
![1630652758221](images/2-SpringMVC/1630652758221.png)

#### 删除

`http://localhost/books/14`

![1630652796605](images/2-SpringMVC/1630652796605.png)

#### 查询单个

`http://localhost/books/1`

![1630652837682](images/2-SpringMVC/1630652837682.png)

#### 查询所有

`http://localhost/books`

![1630652867493](images/2-SpringMVC/1630652867493.png)
...
* 在Controller层增删改返回给前端的是boolean类型数据
  ...
  ![1630653359533](images/2-SpringMVC/1630653359533.png)

* 在Controller层查询单个返回给前端的是对象

  ![1630653385377](images/2-SpringMVC/1630653385377.png)

* 在Controller层查询所有返回给前端的是集合对象

  ![1630653468887](images/2-SpringMVC/1630653468887.png)
...
![1630654293972](images/2-SpringMVC/1630654293972.png)
...
![1630654870632](images/2-SpringMVC/1630654870632.png)
...
![1630656326477](images/2-SpringMVC/1630656326477.png)
...
![1630656982337](images/2-SpringMVC/1630656982337.png)
...
* 异常处理器:
  ...
  * 集中的、统一的处理项目中出现的异常。
    ...
    ![1630657791653](images/2-SpringMVC/1630657791653.png)
...
![1630657972564](images/2-SpringMVC/1630657972564.png)
...
![1630658350945](images/2-SpringMVC/1630658350945.png)
...
![1630658606549](images/2-SpringMVC/1630658606549.png)
...
![1630659060451](images/2-SpringMVC/1630659060451.png)
...
- 业务异常（BusinessException）
  ...
  - 规范的用户行为产生的异常
    ...
    - 用户在页面输入内容的时候未按照指定格式进行数据填写，如在年龄框输入的是字符串
      ...
      ![1630659599983](images/2-SpringMVC/1630659599983.png)

  - 不规范的用户行为操作产生的异常

    - 如用户故意传递错误数据

      ![1630659622958](images/2-SpringMVC/1630659622958.png)
...
- 其他异常（Exception）
  ...
  - 编程人员未预期到的异常，如:用到的文件不存在
    ...
    ![1630659690341](images/2-SpringMVC/1630659690341.png)
...
![1630661162758](images/2-SpringMVC/1630661162758.png)

如果传入的是其他参数，会报`SystemException`

![1630661192383](images/2-SpringMVC/1630661192383.png)
...
![1630658821746](images/2-SpringMVC/1630658821746.png)
...
![1630661781776](images/2-SpringMVC/1630661781776.png)

1. 将`资料\SSM功能页面`下面的静态资源拷贝到webapp下。

![1630663662691](images/2-SpringMVC/1630663662691.png)
...
![1630670317859](images/2-SpringMVC/1630670317859.png)
...
![1630666787456](images/2-SpringMVC/1630666787456.png)

### 4.3 添加功能

![1630670332168](images/2-SpringMVC/1630670332168.png)
...
![1630668954348](images/2-SpringMVC/1630668954348.png)
...
![1630670367812](images/2-SpringMVC/1630670367812.png)
...
![1630673984385](images/2-SpringMVC/1630673984385.png)
...
![1630676280170](images/2-SpringMVC/1630676280170.png)
...
![1630676903190](images/2-SpringMVC/1630676903190.png)
...
![1630677370998](images/2-SpringMVC/1630677370998.png)
...
![1630678114224](images/2-SpringMVC/1630678114224.png)
...
![1630679464294](images/2-SpringMVC/1630679464294.png)
...
![1630680435269](images/2-SpringMVC/1630680435269.png)
...
![1630680579735](images/2-SpringMVC/1630680579735.png)
