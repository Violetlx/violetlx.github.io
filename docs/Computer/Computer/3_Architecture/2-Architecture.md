...
>
> ![image-20250704105202907](images/2-Architecture/image-20250704105202907.png)
>
...
> 32 \text{位计算机中} e = E - 127 \\
> 64 \text{位计算机中} e = E - 1023 \\
> 0< M < 1 ,  \\
> eg: 120.5 \text{使用二进制表示为}1111000.1 \text{，使用二进制科学计数法表示为} 1.1110001 \times 2^6 \\
> \text{其中}M \text{为二进制有效数字} E \text{表示小数点右偏移位数(指数)}
> $$
> S：符号位（表示正负）
>
...
> r ：基数（表示进制位）
>
> *二进制转十进制，整数部分$\sum_{1}^{n}2^{N-1} \times B,\text{其中}B\text{表示二进制}0,1$，小数部分$\sum_{1}^{n}2^{-(N-1)} \times B$*  
>
> ---
>
...
>
> ![image-20250704105211787](images/2-Architecture/image-20250704105211787.png)
>
